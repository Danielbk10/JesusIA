...
export const useWebAuth = () => {
  ...
  const signInWithGoogle = async () => {
    try {
      ...
      // Para fins de desenvolvimento, usaremos dados simulados
      // Em produção, você deve implementar a autenticação real com Google
  ...
  const signInWithFacebook = async () => {
    try {
      ...
      // Para fins de desenvolvimento, usaremos dados simulados
      // Em produção, você deve implementar a autenticação real com Facebook
